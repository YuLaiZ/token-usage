...
| `internal/cli/` | Cobra 命令组装配（config/collect/query/errors/export/chart/forecast/watch/doctor/start/status/stop/restart/version、内置 completion + Hidden `_run`） |
