...
- Collectors for Claude Code/Desktop, OpenCode, Codex, WorkBuddy, ZCode, Zhipu-AutoClaw, and MiMo Code (covering Xiaomi MiMo Desktop and MiMo Code CLI via one shared local database).
